 ...
 * 2020-09-21T21:19:24.408+05:30
 * Generated source version: 3.1.9
 * 
 */
@WebServiceClient(name = "SumWSService", 
                  wsdlLocation = "file:/H:/Software_Development/SOAP-Web-Services-WS-Security-latest/sumwsclient/src/main/resources/sumService.wsdl",
                  targetNamespace = "http://ws.trainings.murugesh.com/") 
public class SumWSService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://ws.trainings.murugesh.com/", "SumWSService");
    public final static QName SumWsPort = new QName("http://ws.trainings.murugesh.com/", "SumWsPort");
    static {
        URL url = null;
        try {
            url = new URL("file:/H:/Software_Development/SOAP-Web-Services-WS-Security-latest/sumwsclient/src/main/resources/sumService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SumWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/H:/Software_Development/SOAP-Web-Services-WS-Security-latest/sumwsclient/src/main/resources/sumService.wsdl");
        }
        WSDL_LOCATION = url;
    }
